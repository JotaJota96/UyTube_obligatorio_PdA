...
public class IniciarSesion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        /**
         * Descripción del siguiente IF
         *  sesReq sesSys  accion a realizar
         *     0     0     Redirigir a iniciar-sesion
         *     0     1     Cerrar la sesion en sys y redirigir a iniciar-sesion
         *     1     0      Cerrar la sesion en req y redirigir a iniciar-sesion
         *     1     1      Redirigir a la pagina de inicio
         */
