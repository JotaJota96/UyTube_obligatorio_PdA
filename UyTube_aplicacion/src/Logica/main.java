...
public class main {
    public static void main(String[] args) {
        ...
        Comentario c1 = new Comentario(Comentario.getNuevoID(), new Date(2019-1900,7,15), "1", 0, u1);

        c1.agregarSubComentario(c1.getId(), new DtComentario(1, null,new Date(2019-1900,7,15), "1.2", 1), u2);
        c1.agregarSubComentario(c1.getId(), new DtComentario(1, null,new Date(2019-1900,7,15), "1.3", 1), u3);
        c1.agregarSubComentario(c1.getId(), new DtComentario(1, null,new Date(2019-1900,7,15), "1.4", 1), u4);
        
        c1.agregarSubComentario(4, new DtComentario(1, null,new Date(2019-1900,7,15), "1.4.5", 2), u3);
